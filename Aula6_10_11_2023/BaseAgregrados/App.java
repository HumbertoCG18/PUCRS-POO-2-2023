...
ToDo: a.	Retornar uma lista com todos os funcionários que recebem insalubridade e tem dependentes.
ToDo: b.	Retornar a quantidade de funcionários que tem dependentes.
ToDo: c.	Retornar o somatório do valor do salário bruto de todos os funcionários que ganham mais de 5000.
ToDo: d.	Aplicar uma taxa de aumento (ex: 1.2 para 20%) em todos os funcionários que recebem insalubridade.
ToDo: e.	Retornar uma lista de strings com nome e a matricula de todos os funcionários cujo salário bruto é mais de 10% maior que o salário base.
ToDo: f.	Retornar a média salarial dos funcionários que não recebem insalubridade.
ToDo: g.	Retornar a lista dos primeiros nomes dos funcionários cujos números de matrícula são menores que 500.
ToDo: h.	Retornar o salário líquido de um funcionário específico ou -1 se o funcionário não for encontrado.
